...
import cn.bmob.imdemo.constant.ContentType;
import cn.bmob.imdemo.constant.HttpHeader;
import cn.bmob.imdemo.constant.HttpMethod;
import cn.bmob.imdemo.constant.HttpSchema;
...
public class HttpUtil {
    ...
    public void httpGet(String path , Map<String , String> pathParams , Map<String , String> queryParams , Map<String , String> headerParams , Callback callback)
    {
        ...
        Request request = this.buildHttpRequest(httpSchema , HttpMethod.CLOUDAPI_GET , Config.APP_HOST , path , pathParams , queryParams , null  , null , ContentType.CLOUDAPI_CONTENT_TYPE_FORM , ContentType.CLOUDAPI_CONTENT_TYPE_JSON , headerParams);
    ...
    public void httpPostForm(String path , Map<String , String> pathParams , Map<String , String> queryParams , Map<String , String> formParams , Map<String , String> headerParams , Callback callback)
    {
        ...
        Request request = this.buildHttpRequest(httpSchema , HttpMethod.CLOUDAPI_POST , Config.APP_HOST , path , pathParams , queryParams , formParams , null , ContentType.CLOUDAPI_CONTENT_TYPE_FORM , ContentType.CLOUDAPI_CONTENT_TYPE_JSON , headerParams);
        Call call = client.newCall(request);
        try {
            Response respnose = call.execute();
            callback.onResponse(call , respnose);
    ...
    /**
     * 图片识别请求
     * @param baseUrl 身份证识别和行驶证识别分两个链接
     * @param path
     * @param pathParams
     * @param queryParams
     * @param body
     ...
     * @param callback
     */
    public void httpPostBytes(String baseUrl, String path , Map<String , String> pathParams , Map<String , String> queryParams , byte[] body , Map<String , String> headerParams , Callback callback)
    {

        Request request = this.buildHttpRequest(httpSchema , HttpMethod.CLOUDAPI_POST , baseUrl , path , pathParams , queryParams , null  , body , ContentType.CLOUDAPI_CONTENT_TYPE_STREAM , ContentType.CLOUDAPI_CONTENT_TYPE_JSON , headerParams);
        Call call = client.newCall(request);
        try {
            Response respnose = call.execute();
            callback.onResponse(call , respnose);
    ...
    public void httpPutBytes(String path , Map<String , String> pathParams , Map<String , String> queryParams , byte[] body , Map<String , String> headerParams , Callback callback)
    {
        ...
        Request request = this.buildHttpRequest(httpSchema , HttpMethod.CLOUDAPI_PUT , Config.APP_HOST , path , pathParams , queryParams , null  , body , ContentType.CLOUDAPI_CONTENT_TYPE_STREAM , ContentType.CLOUDAPI_CONTENT_TYPE_JSON , headerParams);
        Call call = client.newCall(request);
        try {
            Response respnose = call.execute();
            callback.onResponse(call , respnose);
    ...
    public void httpDelete(String path , Map<String , String> pathParams , Map<String , String> queryParams , Map<String , String> headerParams , Callback callback)
    {
        ...
        Request request = this.buildHttpRequest(httpSchema , HttpMethod.CLOUDAPI_DELETE , Config.APP_HOST , path , pathParams , queryParams , null  , null , ContentType.CLOUDAPI_CONTENT_TYPE_FORM , ContentType.CLOUDAPI_CONTENT_TYPE_JSON , headerParams);
        Call call = client.newCall(request);
        try {
            Response respnose = call.execute();
            callback.onResponse(call , respnose);
    ...
    private Request buildHttpRequest(String protocol , String method , String host , String path , Map<String , String> pathParams , Map<String , String> queryParams , Map<String , String> formParams , byte[] body , String requestContentType , String acceptContentType , Map<String , String> headerParams){
        ...
        headerParams.put(SystemHeader.CLOUDAPI_X_CA_KEY, Config.APP_KEY);
